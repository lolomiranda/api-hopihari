INSERT INTO Usuario (id_usuario, first_name, last_name, email, password, birth_date, phone) 
VALUES (1, 'Maria', 'Silva', 'maria.silva@email.com', '1234', '1990-05-15', '1499198-6666');

INSERT INTO Usuario (id_usuario, first_name, last_name, email, password, birth_date, phone) 
VALUES (1, 'Guilherme', 'Devito', 'Gui.Barba@email.com', '1234', '1989-07-23', '1499198-8888');

INSERT INTO Usuario (id_usuario, first_name, last_name, email, password, birth_date, phone) 
VALUES (1, 'João', 'biston', 'Joãov.Biston@email.com', '1234', '1996-12-8', '1499198-5656');



INSERT INTO brinquedo (id_ride, name, waiting_time, status, area) 
